...
#[rustfmt::skip]
pub const DEFAULT_FONT_CHARS: [char; 256] = [
    // 0x0x
    '\0',       '\u{263A}', '\u{263B}', '\u{2665}', '\u{25C6}', '\u{2663}', '\u{2660}', '\u{25CF}',
    '\u{25D8}', '\u{25CB}', '\u{25D9}', '\u{2642}', '\u{2640}', '\u{266A}', '\u{266B}', '\u{263C}',

    // 0x1x
    '\u{25B6}', '\u{25C0}', '\u{2195}', '\u{203C}', '\u{00B6}', '\u{00A7}', '\u{25AC}', '\u{21A8}',
    ...
    // 0xEx
    '\u{2581}', '\u{2582}', '\u{2583}', '\u{2585}', '\u{2586}', '\u{2587}', '\u{258F}', '\u{2594}',
    '\u{2595}', '\0', '\0', '\0', '\u{256D}', '\u{256E}', '\u{256F}', '\u{2570}',
